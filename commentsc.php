...
<body>
	...
	$user_query = mysqli_query($con, "SELECT added_by, user_to FROM postc WHERE id='$post_id'");
	...
	<!-- Load comments -->
		<?php 
		$get_comments=mysqli_query($con,"SELECT * FROM comments WHERE  post_idc='$post_id' ORDER BY id ASC");
