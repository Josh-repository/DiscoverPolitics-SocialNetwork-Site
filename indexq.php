...
if(isset($_POST['Post']))
{
	...
	$post=new Postq($con,$userLoggedIn);
...
<div class="user_details column">
 ...
 <div class="main_column column">
 	<form class="post_form" action=indexq.php method="POST">
...
<script>
	...
	$(document).ready(function() {
		...
		$.ajax({
			url: "includes/handelers/ajax_load_postq.php",
			type: "POST",
		...
		$(window).scroll(function() {	
			...
			if (document.documentElement.scrollHeight == (document.documentElement.scrollTop + window.innerHeight) && noMorePosts == 'false')
			 {	
				...
				var ajaxReq = $.ajax({
					url: "includes/handelers/ajax_load_posta.phq",
					type: "POST",
